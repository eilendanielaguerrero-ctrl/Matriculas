...
<head>
    ...
    <link href="/matriculas/assets/css/styles.css" rel="stylesheet">
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#5BE538;">
        <div class="container">
            <a class="navbar-brand fw-bold" href="/matriculas/index.php">Matrículas</a>
